...
impl Compress {
    pub fn zlib(data: &[u8], level: Compression) -> Results<Vec<u8>> {
    ...
    pub fn un_zlib(data: &[u8]) -> Results<Vec<u8>> {
    ...
    pub fn deflate(data: &[u8], level: Compression) -> Results<Vec<u8>> {
    ...
    pub fn un_deflate(data: &[u8]) -> Results<Vec<u8>> {
    ...
    pub fn gzip(data: &[u8], level: Compression) -> Results<Vec<u8>> {
    ...
    pub fn un_gzip(data: &[u8]) -> Results<Vec<u8>> {
